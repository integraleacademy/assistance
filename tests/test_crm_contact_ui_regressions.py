...
"""
    ...
    assert 'CRM_ASSET_VERSION = "20260827-next-action-voice-dictation-4"' in backend
...
"""
    ...
    assert "20260827-next-action-voice-dictation-4" in application
...
"""
    ...
    assert 'CRM_ASSET_VERSION = "20260827-next-action-voice-dictation-4"' in application
