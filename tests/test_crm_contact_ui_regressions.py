...
"""
    ...
    assert 'CRM_ASSET_VERSION = "20260901-email-attachments-1"' in backend
...
"""
    ...
    assert "20260901-email-attachments-1" in application
...
"""
    ...
    assert 'CRM_ASSET_VERSION = "20260901-email-attachments-1"' in application
