...
"""
    ...
    assert 'CRM_ASSET_VERSION = "20260827-call-voice-commands-2"' in backend
...
"""
    ...
    assert "20260827-call-voice-commands-2" in application
...
"""
    ...
    assert 'CRM_ASSET_VERSION = "20260827-call-voice-commands-2"' in application
